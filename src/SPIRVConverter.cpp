...
std::vector<unsigned int> SPIRVConverter::GLSL2SPRIV( const std::string &fileName )
{
  ...
  using namespace std::filesystem;
	...
	if ( extension == ".vert" ) {
		...
		shaderType = ShaderType::TessllationControl;
	} else if ( extension == ".tese" ) {
		shaderType = ShaderType::TessllationEvaluate;
  ...
  return GLSL2SPRIVFromFile(fileName, shaderType);

}
std::vector<unsigned int> SPIRVConverter::GLSL2SPRIVFromSource( const std::string &glslCode, ShaderType type )
{
  using namespace std;
	using namespace std::filesystem;
  ...
  switch (type) {
    case ShaderType::Vertex: shaderType = EShLangVertex;break;
    case ShaderType::TessllationControl: shaderType = EShLangTessControl;break;
    case ShaderType::TessllationEvaluate: shaderType = EShLangTessEvaluation;break;
    case ShaderType::Geometry: shaderType = EShLangGeometry;break;
    case ShaderType::Fragment: shaderType = EShLangFragment;break;
    case ShaderType::Compute: shaderType = EShLangCompute;break;
  }
...
std::vector<unsigned int> SPIRVConverter::GLSL2SPRIVFromFile( const std::string &fileName, ShaderType shaderType )
{
  using namespace std;
  ...
  return GLSL2SPRIVFromSource(glslCode,shaderType);
}
